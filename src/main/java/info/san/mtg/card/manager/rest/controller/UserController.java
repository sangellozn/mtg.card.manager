...
public class UserController {
	...
	@PutMapping("{uuid}/cards/{cardUuid}")
	public void updateUserCardInfo(@PathVariable("uuid") String uuid, @RequestBody @Validated UpdateUserCardInfoDto updateUserCardInfoDto) {
		userService.updateUserCardInfo(uuid, updateUserCardInfoDto);
	}
